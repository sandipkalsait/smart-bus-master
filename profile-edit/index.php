                ...
                <div class="picCard text-center">
                    <div class="avatar-upload">
                        ...
                        <div class="avatar-edit" aria-hidden="true">
                            <input name='avatar' id="avatar" class="fa fa-pencil-alt fa-1x edit-profile" type='file'
                                aria-hidden="true" />
                            <label for="avatar">
                                <!-- <span class="glyphicon glyphicon-camera"><i class="fa fa-pencil-alt fa-1x edit-profile" aria-hidden="true"></i></span>
