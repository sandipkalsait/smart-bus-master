<div class="sidebar " >
    ...
    <ul class="widget widget-menu unstyled mt-5" >
        <li class="active"><a href="index.php"><i class="menu-icon icon-dashboard"></i>Dashboard
            </a></li>
        <li><a href="includes/Notification.php"><i class="menu-icon icon-bullhorn"></i>Nofications </a>
        </li>
    ...
    <ul class="widget widget-menu unstyled">
        ...
        <li><a href="includes/live_bus.php"><i class="menu-icon icon-paste"></i>live buss</a></li>
        <li><a href="includes/schedule.php"><i class="menu-icon icon-table"></i>Schedules</a></li>
        <li><a href="includes/charts.php"><i class="menu-icon icon-bar-chart"></i>Charts </a></li>
    </ul>
    <!--/.widget-nav-->
    <!-- <ul class="widget widget-menu unstyled">
