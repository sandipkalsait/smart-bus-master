...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Smart Bus System');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'Modern College Project');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'Sandip.kalsait');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'Embeddable Smart Bus System');

if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time()+1*60);

if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'smartbus_DB');
