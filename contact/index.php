        ...
        <div class="col-sm-9 px-5">
            ...
            <form class="form-auth" action="includes/contact.inc.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea type="password" id="message"  name="message" class="form-control" placeholder="Message" required></textarea>
                </div>

                <div class="text-center mx-5 px-5">
                    <button class="btn btn-primary btn-block" type="submit" name="contact-submit" value="contact-submit">Submit</button>
                </div>

                <p class="mt-4 mb-3 text-muted text-center">
                    <a href="https://github.com/sandipkalsait/smart-bus-master" target="_blank">
                        Smart Bus System
                    </a> 
